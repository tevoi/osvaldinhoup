...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Tevogg\n' // Nome do dono 
            + 'ORG:CaussBot;\n' // Nome do Bot
            + 'TEL;type=CELL;type=VOICE;waid=555491057713:+55 5491057713\n' //número do zapo
            + 'END:VCARD'
			...
			case 'closegp':
               ...
               if (anu.error) return reply(anu.error)
				...
				if (!isGroup) return reply(mess.only.group)
					...
					break
			    case 'owner':
                    client.sendMessage(from, {displayname: "Tevo", vcard: vcard}, MessageType.contact, { quoted: msg})
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: msg, caption: '️*canal do Tevo:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
